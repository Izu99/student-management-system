    ...
    <div className="flex flex-col h-screen justify-center items-center" style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' }}>
      <div className="bg-gray-800 p-8 rounded-lg shadow-md" style={{ width: '400px' }}>
        <form onSubmit={handleRegister} className="space-y-4">
          <h2 className="text-4xl font-bold text-white mb-8 text-center">User Registration</h2>
          <div className="mb-4">
          ...
          <input
            value={role}
            readOnly
            className="p-2 w-full border rounded-md bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <button
            type="submit"
